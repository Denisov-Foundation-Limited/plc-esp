...
BoardProfile PROGMEM ActiveBoard = {
    ...
    .interfaces = {
        .gpio = {
            ...
            { .name = "in-0/1",  .type = PROF_TYPE_DINPUT,  .pin = 2,  .mode = PROF_MODE_INPUT,  .pull = PROF_PULL_NONE, .extId = 0 },
            { .name = "in-0/2",  .type = PROF_TYPE_DINPUT,  .pin = 1,  .mode = PROF_MODE_INPUT,  .pull = PROF_PULL_NONE, .extId = 0 },
