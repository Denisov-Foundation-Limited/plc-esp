...
BoardProfile PROGMEM ActiveBoard = {
    ...
    .interfaces = {
        ...
        .gpio = {
            ...
            { .id = 17, .pin = 8,  .type = PROF_GPIO_INPUT,   .ext = 1 },
            { .id = 18, .pin = 9,  .type = PROF_GPIO_INPUT,   .ext = 1 },
            { .id = 19, .pin = 10, .type = PROF_GPIO_INPUT,   .ext = 1 },
            { .id = 20, .pin = 11, .type = PROF_GPIO_INPUT,   .ext = 1 },
            { .id = 21, .pin = 12, .type = PROF_GPIO_INPUT,   .ext = 1 },
            { .id = 22, .pin = 13, .type = PROF_GPIO_INPUT,   .ext = 1 },
            { .id = 23, .pin = 14, .type = PROF_GPIO_INPUT,   .ext = 1 },
            { .id = 24, .pin = 0,  .type = PROF_GPIO_INPUT,   .ext = 1 },
